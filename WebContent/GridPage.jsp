...
<link rel="stylesheet" rev="stylesheet" type="text/css" href="css/jquery-ui.css" media="screen" /> 
			...
			<div class="cbp-pgcontent">
				<div class="cbp-pgitem">
					<div class="cbp-pgitem-flip">
						<img  data-geo=""  summary="<%out.print(p.getSummary());%>"   title="<%out.print(p.getTitle());%>"  description="<%out.print(p.getDescription());%>" src=<%out.print(p.getImgLink());%> />
					</div>
				</div><!-- /cbp-pgitem -->
				<ul class="cbp-pgoptions">							
						...
						<div class="cbp-pgopttooltip">
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="1'>1</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="2"'>2</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="3 "'>3</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="4 "'>4</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="5 "'>5</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="6 "'>6</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="7 "'>7</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="8 "'>8</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="9 "'>9</span>
							<span data-size='XL' onclick='document.getElementById("<%out.print(p.getTitle()); %>").innerHTML="10 "'>10</span>
						</div>
							<%
						}	
						%>
					...
					<%}  else { %>
					<span id="<%out.print(p.getTitle()); %>" data-size="XL"><%out.print(((double)p.getPrice())/100 + " €"); %></span>
					<%} %>	</li>
				</ul><!-- cbp-pgoptions -->
